...
static bool match(Lexer* lexer, char expected) {
    if (lexer->source[lexer->current] == '\0') return false;
...
static void scan_token(Lexer* lexer) {
    ...
    switch (c) {
        case '(': add_token(lexer, LEFT_PAREN, NULL); break;
        case ')': add_token(lexer, RIGHT_PAREN, NULL); break;
        case '{': add_token(lexer, LEFT_BRACE, NULL); break;
        case '}': add_token(lexer, RIGHT_BRACE, NULL); break;
        case '[': add_token(lexer, LEFT_BRACKET, NULL); break;
        case ']': add_token(lexer, RIGHT_BRACKET, NULL); break;
        case ',': add_token(lexer, COMMA, NULL); break;
        case '.': add_token(lexer, DOT, NULL); break;
        case '-': add_token(lexer, MINUS, NULL); break;
        case '+': add_token(lexer, PLUS, NULL); break;
        case ';': add_token(lexer, SEMICOLON, NULL); break;
        case '*': add_token(lexer, MULTIPLY, NULL); break;
        case '/':
            if (match(lexer, '/')) {
